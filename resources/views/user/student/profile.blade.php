                            ...
                            <div class="mentor-widget">
                                <div class="user-info-left align-items-center">
                                    ...
                                    <div class="user-info-cont">
                                        ...
                                        <p class="mentor-type">{{ $user?->additional?->headline ? $user?->additional?->headline : 'Headline not set' }}</p>
                                        <div class="mentor-action">
                                            <p class="mentor-type social-title">Contact Me</p>
                                            <a href="tel:{{ $user?->additional?->mobile }}" class="btn-blue" data-toggle="modal"
                                        ...
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row-result">{{ $user?->additional?->date_of_birth ? $user?->additional?->date_of_birth : 'Not set' }}</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                    ...
                                    <ul class="experience-list profile-custom-list">
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <span>Address</span>
                                                    <div class="row-result">{{ $user?->additional?->address ? $user?->additional?->address : 'Not set' }}</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <span>Country</span>
                                                    <div class="row-result">{{$user?->additional?->country ? $user?->additional?->country : 'Not set'}}</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <span>City</span>
                                                    <div class="row-result">{{ $user?->additional?->city ? $user?->additional?->city : 'Not set'  }}</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    <span>State</span>
                                                    <div class="row-result">{{ $user?->additional?->state ? $user?->additional?->state : 'Not set' }}</div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="experience-content">
                                                <div class="timeline-content">
                                                    ...
                                                    <div class="row-result">{{ $user?->additional?->postal_code ? $user?->additional?->postal_code : 'Not set' }}</div>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
